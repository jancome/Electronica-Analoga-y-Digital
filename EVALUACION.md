...
4. Palabras clave.
5. Introducción.
6. Resultados: circuitos, tablas, mediciones, capturas y fotos.
...
Durante la sustentación se podrán realizar preguntas sobre:
...
- Fallas encontradas y correcciones aplicadas.
- Participación real del estudiante en el desarrollo del proyecto o laboratorio.

## Escala sugerida

| Nivel | Rango | Descripción |
|---|---:|---|
| Avanzado | 4.1 – 5.0 | Domina el tema, justifica técnicamente y aplica correctamente. |
| Satisfactorio | 3.1 – 4.0 | Comprende y aplica con algunas limitaciones menores. |
| Mínimo | 1.6 – 3.0 | Presenta comprensión parcial y dificultades en la aplicación. |
| Insuficiente | 0.0 – 1.5 | No evidencia dominio suficiente del tema. |
